    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItem => {
                ...
                const inputs = [ rangeItem.querySelector("[data-range-from]"), rangeItem.querySelector("[data-range-to]") ];
                ...
                item.noUiSlider.on("update", (function(values, handle) {
                    inputs[handle].value = Math.round(values[handle]) + " руб.";
                }));
            }));
        }
        rangeInit();
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    ...
                    slideChange: function(swiper) {
                        ...
                        currentSlide.innerHTML = swiper.realIndex + 1 < 10 ? `0${swiper.realIndex + 1}` : swiper.realIndex;
                    }
                }
            });
